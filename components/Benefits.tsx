        ...
        <div className="grid gap-6 md:grid-cols-3">
          {BENEFITS.map((benefit, idx) => {
            ...
            return (
              <div
                key={benefit.label}
                className={`rounded-2xl border border-gray-100 bg-white p-8 text-center shadow-sm transition-all duration-700 hover:shadow-md ${
                  visible
              ...
              >
                ...
                <p className="mb-3 whitespace-nowrap text-3xl font-bold text-primary-800">
                  {benefit.value}
                </p>
